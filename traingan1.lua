...
opt = {
   ...
   cls_weight = 0,
   filenames = '',
   data_root = '/home/research_centre_gpu/Keyboard/coco/ShortlistedAnnotations/001.backpack',
   ...
   display_id = 2,        -- display window id.
...
for epoch = 1, opt.niter do
  ...
  if epoch % opt.save_every == 0 then
    ...
    torch.save(opt.checkpoint_dir .. '/' .. opt.name .. '_' .. epoch .. '_net_G_stage1.t7', netG)
    torch.save(opt.checkpoint_dir .. '/' .. opt.name .. '_' .. epoch .. '_net_D_stage1.t7', netD)
    torch.save(opt.checkpoint_dir .. '/' .. opt.name .. '_' .. epoch .. '_opt_stage1.t7', opt)
